...
class ATL_NO_VTABLE CObjectDemoSimulation :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CObjectDemoSimulation, &CLSID_ObjectDemoSimulation>,
	public IDispatchImpl<IObjectDemoSimulation, &IID_IObjectDemoSimulation, &LIBID_ObjectDemoLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	BEGIN_COM_MAP(CObjectDemoSimulation)
		COM_INTERFACE_ENTRY(IObjectDemoSimulation)
		COM_INTERFACE_ENTRY2(IDispatch, IObjectDemoSimulation)
...
OBJECT_ENTRY_AUTO(__uuidof(ObjectDemoSimulation), CObjectDemoSimulation)
