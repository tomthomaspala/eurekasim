...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("ObjectDemo Experiment Simulation Demo")
...
public:
	...
	CObjectDemoSimulation*						m_pAddin;
	...
	CAddinSimulationManager(CObjectDemoSimulation* pAddin);
